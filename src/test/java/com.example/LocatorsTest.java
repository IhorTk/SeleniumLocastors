...
public class LocatorsTest {
    ...
    public void testCssLocators() {
        ...
        WebElement tShirtAddToCartButton = driver.findElement(By.cssSelector("button#add-to-cart-sauce-labs-bolt-t" +
                "-shirt"));
        tShirtAddToCartButton.click();

        WebElement bikeLightPageLink = driver.findElement(By.cssSelector("img[alt='Sauce Labs Bike Light'"));
        bikeLightPageLink.click();

        WebElement bikeLightAddToCartButton = driver.findElement(By.cssSelector("button#add-to-cart"));
    ...
    public void testXpathLocators() {
        ...
        WebElement tShirtAddToCartButton = driver.findElement(By.xpath("//button[@id='add-to-cart-sauce-labs-bolt-t" +
                        "-shirt']"));
        tShirtAddToCartButton.click();

        WebElement bikeLightPageLink = driver.findElement(By.xpath(".//*[.='Sauce Labs Bike Light']"));
        bikeLightPageLink.click();

        WebElement bikeLightAddToCartButton = driver.findElement(By.xpath("//button[@id='add-to-cart']"));
        bikeLightAddToCartButton.click();

        WebElement cartLink = driver.findElement(By.xpath("//div/a"));
        cartLink.click();
